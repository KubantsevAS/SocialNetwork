    ...
    <div>
      <div className={styles.mainInfo}>
        ...
        <div className={styles.mainInfo__item} subscribe="Job Status">
          {props.profile.lookingForAJob ? (
            <>
              Looking for a job: <b>YES</b>
            </>
          ) : (
            <>
              Looking for a job: <b>NO</b>
            </>
          )}
        </div>
        {props.profile.lookingForAJob && (
          <div
            className={styles.mainInfo__item}
            subscribe="My Professional Skills"
          >
      ...
      <div>
        ...
        <div className={styles.contactsContainer}>
          {Object.keys(props.profile.contacts).filter(
            (key) =>
              props.profile.contacts[key] !== null &&
            ...
            Object.keys(props.profile.contacts).map((key, index) => {
              ...
              return (
                ...
                >
                  <img
                    src={iconArr[index]}
                    alt={props.profile.contacts[key]}
