            ...
            {({ handleSubmit, pristine, form, submitting, submitError }) => (
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.checkboxContainer}>
                        <Field type={"checkbox"} component={"input"} name={"rememberMe"} className={styles.checkboxField} />
                    ...
                    <div>
                        ...
                        <div className={styles.btnContainer}>
                            ...
                            <label htmlFor={"subBtn"} className={styles.subBtn}>Log In
                                <button
                                    type={"submit"}
                                    disabled={submitting}
                                    id={"subBtn"}
                            ...
                            <label htmlFor={"clearBtn"} className={styles.subBtn + " " + styles.clearBtn}>Clear Values
                                <button
                                    type="button"
