    ...
    return (
        <div className={styles.aboutTab}>
            ...
            <div className={styles.loginInfo}>
                ...
                <p>Without logging in, you can only check the 'All users' and the 'About' tabs.<br />
            ...
            <div className={styles.mainInfo}>
                ...
                <div className={styles.mainInfoItem} >On the 'All users' tab, you can see all the Network users. You can go to each user's page and also click the button to follow or unfollow user.</div>
